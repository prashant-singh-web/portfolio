...
function Aboutme() {
  ...
  <p className="text-base leading-relaxed text-gray-400">
    I began my web development journey in <span className="text-white font-medium">2019</span>, starting with the
    fundamentals of HTML and CSS, and quickly progressed to JavaScript and modern frontend technologies. Since then,
    I’ve built a variety of responsive, user-friendly web applications using{" "}
